...
export default function KommunikationsVorlagen(){return <div className="appShell"><Sidebar/><main className="main"><Topbar title="Vorlagen" subtitle="WhatsApp, E-Mail und Systemtexte"/><div className="content"><EntityModule title="Kommunikationsvorlagen" subtitle="Lokale Vorlagen mit optionaler Zuordnung zu Meta WhatsApp Templates" endpoint="/api/message-templates" itemsKey="templates" createLabel="Vorlage anlegen" deleteLabel="Vorlage deaktivieren" columns={[
