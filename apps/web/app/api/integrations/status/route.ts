...
export async function GET(){
  const [vehicleCount,samsaraVehicles,telemetryCount,latestTelemetry,documentCount,latestDocument,folderMappings,states,dddBatches,dddViolations,latestDdd]=await Promise.all([
